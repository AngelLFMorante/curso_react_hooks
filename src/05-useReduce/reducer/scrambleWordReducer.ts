...
//! se pueden separar porque son funciones helpers.
...
//aqui se ve bien las acciones de la aplicacion, como saltar, jugar nuevo, etc.. 
export type ScrambleWordsAction =
    //! no poner espacios si escribo cosas lo mejor es camel_snake
