...
export const TasksApp = () => {
    ...
    //para persistir en el localstorage
    useEffect(() => {
    ...
    const addTodo = () => {
        ...
        //me he llevado esto al taskReduce
        // const newTodo: Todo = {
        //     id: Date.now(),
        ...
        //para hacer un cambio a un objeto o algo haay que hacerlo con dispatcher no hay que usar push
